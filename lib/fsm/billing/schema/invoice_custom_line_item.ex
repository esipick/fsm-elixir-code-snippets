defmodule Fsm.Billing.InvoiceCustomLineItem do
  use Ecto.Schema
  ...
  @required_fields ~w(default_rate description taxable deductible school_id)a

  schema "invoice_custom_line_items" do
    field(:default_rate, :integer)
    field(:description, :string)
    field(:taxable, :boolean, default: false)
    field(:deductible, :boolean, default: false)
