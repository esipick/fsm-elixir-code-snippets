defmodule FsmCal.KV do
  ...
  Convert a key and value to an iCal line:
      ...
      iex> Fsm.Utils.KV.build("foo", "bar")
      "foo:bar\n"

  Don't add empty values:

      iex> Fsm.Utils.KV.build("foo", nil)
      ""
  ...
  Attendees get their own line, each:
        ...
        ...> ]
        iex> Fsm.Utils.KV.build("ATTENDEES", attendees)
